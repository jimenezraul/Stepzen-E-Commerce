            ...
            <div className='xl:w-96'>
              <div className='input-group relative flex flex-wrap items-stretch w-fullrounded'>
                <input
                  ...
                  type='search'
                  className='mb-1 form-control relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none'
                  placeholder='Search'
                  aria-label='Search'
